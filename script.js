...
const bluedata = document.querySelector("#bluedata");
const reddata = document.querySelector("#reddata");
...
function resetGame(){
    ...
    text.innerHTML = "Welcome To 's Circuit Game , Hope You Enjoy The Game. </br> Blue Starts The Game"
    bluetimer.style.backgroundColor = "yellow";
    bluedata.style.backgroundColor = "yellow";
...
function switchPlayer(){
    if(!gamePaused && blue.activeTurn){
        ...
        redtimer.style.backgroundColor = "yellow";
        reddata.style.backgroundColor = "yellow";
